...
`)),br=r=>{const{classes:e,variant:t,color:i}=r,h={root:["root",`color${f(i)}`,t],dashed:["dashed",`dashedColor${f(i)}`],bar1:["bar",`barColor${f(i)}`,(t==="indeterminate"||t==="query")&&"bar1Indeterminate",t==="determinate"&&"bar1Determinate",t==="buffer"&&"bar1Buffer"],bar2:["bar",t!=="buffer"&&`barColor${f(i)}`,t==="buffer"&&`color${f(i)}`,(t==="indeterminate"||t==="query")&&"bar2Indeterminate",t==="buffer"&&"bar2Buffer"]};return rr(h,cr,e)},N=(r,e)=>e==="inherit"?"currentColor":r.vars?r.vars.palette.LinearProgress[`${e}Bg`]:r.palette.mode==="light"?er(r.palette[e].main,.62):tr(r.palette[e].main,.5),gr=A("span",{name:"MuiLinearProgress",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:t}=r;return[e.root,e[`color${f(t.color)}`],e[t.variant]]}})(({ownerState:r,theme:e})=>v({position:"relative",overflow:"hidden",display:"block",height:4,zIndex:0,"@media print":{colorAdjust:"exact"},backgroundColor:N(e,r.color)},r.color==="inherit"&&r.variant!=="buffer"&&{backgroundColor:"none","&::before":{content:'""',position:"absolute",left:0,top:0,right:0,bottom:0,backgroundColor:"currentColor",opacity:.3}},r.variant==="buffer"&&{backgroundColor:"transparent"},r.variant==="query"&&{transform:"rotate(180deg)"})),hr=A("span",{name:"MuiLinearProgress",slot:"Dashed",overridesResolver:(r,e)=>{const{ownerState:t}=r;return[e.dashed,e[`dashedColor${f(t.color)}`]]}})(({ownerState:r,theme:e})=>{const t=N(e,r.color);return v({position:"absolute",marginTop:0,height:"100%",width:"100%"},r.color==="inherit"&&{opacity:.3},{backgroundImage:`radial-gradient(${t} 0%, ${t} 16%, transparent 42%)`,backgroundSize:"10px 10px",backgroundPosition:"0 -23px"})},L(z||(z=C`
  ...
  `),mr)),xr=A("span",{name:"MuiLinearProgress",slot:"Bar1",overridesResolver:(r,e)=>{const{ownerState:t}=r;return[e.bar,e[`barColor${f(t.color)}`],(t.variant==="indeterminate"||t.variant==="query")&&e.bar1Indeterminate,t.variant==="determinate"&&e.bar1Determinate,t.variant==="buffer"&&e.bar1Buffer]}})(({ownerState:r,theme:e})=>v({width:"100%",position:"absolute",left:0,bottom:0,top:0,transition:"transform 0.2s linear",transformOrigin:"left",backgroundColor:r.color==="inherit"?"currentColor":(e.vars||e).palette[r.color].main},r.variant==="determinate"&&{transition:`transform .${O}s linear`},r.variant==="buffer"&&{zIndex:1,transition:`transform .${O}s linear`}),({ownerState:r})=>(r.variant==="indeterminate"||r.variant==="query")&&L(w||(w=C`
    ...
    `),fr)),vr=R.forwardRef(function(e,t){const i=J({props:e,name:"MuiLinearProgress"}),{className:h,color:M="primary",value:s,valueBuffer:T,variant:l="indeterminate"}=i,m=Q(i,ur),u=v({},i,{color:M,variant:l}),b=br(u),x=Y(),d={},g={bar1:{},bar2:{}};if((l==="determinate"||l==="buffer")&&s!==void 0){d["aria-valuenow"]=Math.round(s),d["aria-valuemin"]=0,d["aria-valuemax"]=100;let c=s-100;x.direction==="rtl"&&(c=-c),g.bar1.transform=`translateX(${c}%)`}if(l==="buffer"&&T!==void 0){let c=(T||0)-100;x.direction==="rtl"&&(c=-c),g.bar2.transform=`translateX(${c}%)`}return a.jsxs(gr,v({className:Z(b.root,h),ownerState:u,role:"progressbar"},d,{ref:t},m,{children:[l==="buffer"?a.jsx(hr,{className:b.dashed,ownerState:u}):null,a.jsx(xr,{className:b.bar1,ownerState:u,style:g.bar1}),l==="determinate"?null:a.jsx(pr,{className:b.bar2,ownerState:u,style:g.bar2})]}))}),Cr=vr,I=[{key:"ALL_GROWTH_RATE",label:"All Students Growth",fmt:"pct"},{key:"ECODIS_GROWTH_RATE",label:"Econ Disadv. Growth",fmt:"pct"},{key:"HISPANIC_GROWTH_RATE",label:"Hispanic Growth",fmt:"pct"},{key:"WHITE_GROWTH_RATE",label:"White Growth",fmt:"pct"},{key:"AFR_AMER_GROWTH_RATE",label:"African American Growth",fmt:"pct"},{key:"FEMALE_GROWTH_RATE",label:"Female Growth",fmt:"pct"},{key:"MALE_GROWTH_RATE",label:"Male Growth",fmt:"pct"}],Tr={ALL_GROWTH_RATE:"ALL_STUDENT_COUNT",ECODIS_GROWTH_RATE:"ECODIS_COUNT",HISPANIC_GROWTH_RATE:"HISPANIC_COUNT",WHITE_GROWTH_RATE:"WHITE_COUNT",AFR_AMER_GROWTH_RATE:"AFR_AMER_COUNT",FEMALE_GROWTH_RATE:"FEMALE_COUNT",MALE_GROWTH_RATE:"MALE_COUNT"},k=r=>r==null||Number.isNaN(r)?"—":Intl.NumberFormat().format(r),K=r=>r==null||Number.isNaN(r)?"—":Intl.NumberFormat(void 0,{style:"percent",maximumFractionDigits:1}).format(r);function kr(r){var j,S;const e=Y(),t=Array.isArray(r==null?void 0:r.data23)?r.data23:ir??[],i=Array.isArray(r==null?void 0:r.data24)?r.data24:sr??[],[h,M]=R.useState(2024),[s,T]=R.useState("ALL_GROWTH_RATE"),l=h===2023?t:i,m=((j=I.find(o=>o.key===s))==null?void 0:j.fmt)==="pct",u=m?K:k,b=R.useMemo(()=>{const o=Array.isArray(l)?l:[],p=Tr[s]??"ALL_STUDENT_COUNT";return o.filter(n=>n&&n[s]!=null).map(n=>({campus:n.CAMPUS,value:n[s],n:(n==null?void 0:n[p])??null})).sort((n,_)=>n.value-_.value).slice(0,12)},[l,s]),x=e.palette.text.primary,d=e.palette.mode==="dark"?$("#ffffff",.22):$("#000000",.12),g={color:"#0c0b0bff","& .MuiSvgIcon-root":{color:"#292020ff"},"& .MuiOutlinedInput-notchedOutline":{borderColor:"rgba(0,0,0,0.25)"},"&:hover .MuiOutlinedInput-notchedOutline":{borderColor:"rgba(0,0,0,0.45)"},"&.Mui-focused .MuiOutlinedInput-notchedOutline":{borderColor:"rgba(0,0,0,0.65)"}},c={PaperProps:{sx:{bgcolor:"#fff",color:"#111",maxHeight:360,"& .MuiMenuItem-root.Mui-selected":{bgcolor:"rgba(0,0,0,0.06)"},"& .MuiMenuItem-root.Mui-selected:hover":{bgcolor:"rgba(0,0,0,0.10)"}}}};return a.jsx(ar,{sx:{bgcolor:"background.paper",height:460},children:a.jsxs(or,{sx:{height:"100%"},children:[a.jsxs(lr,{direction:{xs:"column",md:"row"},spacing:2,alignItems:{md:"center"},sx:{mb:1},children:[a.jsx(y,{sx:{flex:1},children:a.jsxs(G,{variant:"subtitle1",sx:{color:"#000",fontSize:20,fontWeight:600},children:["Metric — ",(S=I.find(o=>o.key===s))==null?void 0:S.label]})}),a.jsxs(W,{size:"small",sx:{minWidth:120},children:[a.jsx(H,{sx:{color:"black"},children:"Year"}),a.jsxs(B,{label:"Year",value:h,onChange:o=>M(Number(o.target.value)),sx:g,MenuProps:c,children:[a.jsx(E,{value:2023,children:"2023"}),a.jsx(E,{value:2024,children:"2024"})]})]}),a.jsxs(W,{size:"small",sx:{minWidth:220},children:[a.jsx(H,{sx:{color:"black"},children:"Metric"}),a.jsx(B,{label:"Metric",value:s,onChange:o=>T(o.target.value),sx:g,MenuProps:c,children:I.map(o=>a.jsx(E,{value:o.key,children:o.label},o.key))})]})]}),a.jsx(y,{sx:{height:360},children:b.length?a.jsx(nr,{data:b,layout:"horizontal",keys:["value"],indexBy:"campus",margin:{top:10,right:24,bottom:56,left:200},padding:.3,colors:["#59A14F"],enableGridY:!1,enableGridX:!0,valueScale:{type:"linear",min:0,max:m?1:"auto"},axisLeft:{tickSize:0,tickPadding:6},axisBottom:{tickSize:0,tickPadding:8,tickRotation:0,tickValues:m?[0,.25,.5,.75,1]:void 0,format:o=>m?K(o):k(o),legend:m?" ":"",legendOffset:40,legendPosition:"middle"},labelSkipWidth:60,label:o=>{var _;const p=(_=o.data)==null?void 0:_.n,n=p==null?"":`  (n=${k(p)})`;return`${u(o.value)}${n}`},valueFormat:o=>u(o),theme:{textColor:x,labels:{text:{fontSize:20,fill:"black"}},axis:{domain:{line:{stroke:d}},ticks:{text:{fontSize:15,fill:x},line:{stroke:d}},legend:{text:{fill:x}}},grid:{line:{stroke:d,strokeDasharray:"4 4"}},tooltip:{container:{fontSize:14,background:"rgba(0,0,0,0.9)",color:"#fff",border:`1px solid ${d}`}}},tooltip:({data:o,value:p})=>a.jsx(y,{sx:{p:1},children:a.jsxs(G,{variant:"caption",children:[a.jsx("strong",{children:o.campus}),a.jsx("br",{}),u(p)," ",o.n!=null?`• n=${k(o.n)}`:""]})})}):a.jsx(y,{sx:{mt:4},children:a.jsx(Cr,{})})})]})})}export{kr as default};
